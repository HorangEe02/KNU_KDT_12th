...
워드클라우드 시각화 모듈
=============================================================
cross.png 마스크를 활용한 의료 AI 특화 워드클라우드 6종 생성
=============================================================
"""
...
class WordCloudVisualizer:
    ...
    def generate_tech_stack_wordcloud(self, tech_data):
        """채용공고 기술스택 워드클라우드 (cross.png 마스크 적용)"""
        print("\n  [1/6] 채용공고 기술스택 워드클라우드")
        self._create_wordcloud(
            tech_data,
            "의료 AI 채용공고 기술스택 워드클라우드",
            "wc_tech_stack.png",
            colormap="cool",
        )
    ...
    def generate_job_requirements_wordcloud(self, req_texts):
        ...
        self._create_wordcloud(
            req_texts,
            "의료/제약/바이오 채용 자격요건·우대사항 워드클라우드",
            "wc_job_requirements.png",
            colormap="coolwarm",
        )

    def generate_medical_domain_wordcloud(self, domain_texts):
        """의료 도메인 키워드 워드클라우드 (cross.png 마스크 적용)"""
        print("\n  [6/6] 의료 도메인 키워드 워드클라우드")
        self._create_wordcloud(
            domain_texts,
            "의료 AI 도메인 키워드 워드클라우드",
    ...
    def generate_all(self, data_dict: dict):
        ...
        if data_dict.get("medical_domain"):
            self.generate_medical_domain_wordcloud(data_dict["medical_domain"])
