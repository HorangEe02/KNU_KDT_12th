...
사람인 채용공고 시각화 모듈
=============================================================
사람인 의료 AI 채용공고 데이터를 활용한 시각화 7종 생성
- 직무분야 분포 (Top 15)
- 경력조건 분포 (도넛)
- 학력조건 분포
- 근무지역 분포 (Top 15)
...
class SaraminVisualizer:
    ...
    def plot_job_sector_dist(self):
        ...
        ax.set_title("사람인 의료 AI 채용공고 직무분야 Top 15",
    ...
    def plot_career_dist(self):
        ...
        ax.set_title(f"사람인 의료 AI 채용공고 경력조건 분포 (총 {len(self.df)}건)",
    ...
    def plot_education_dist(self):
        ...
        ax.set_title("사람인 의료 AI 채용공고 학력조건 분포",
                      fontsize=20, fontweight="bold", pad=15)
    ...
    def plot_location_dist(self):
        ...
        ax.invert_yaxis()
        ax.set_xlabel("공고 수", fontsize=16)
        ax.set_title("사람인 의료 AI 채용공고 근무지역 Top 15",
                      fontsize=20, fontweight="bold", pad=15)
    ...
    def plot_employment_type(self):
        ...
        ax.set_title("사람인 의료 AI 채용공고 고용형태 분포",
                      fontsize=18, fontweight="bold", pad=20)
    ...
    def plot_tech_stack_dist(self):
        ...
        ax.set_title("사람인 의료 AI 채용공고 기술스택 Top 15",
                      fontsize=20, fontweight="bold", pad=15)
    ...
    def plot_company_positions(self):
        ...
        ax.invert_yaxis()
        ax.set_xlabel("공고 수", fontsize=16)
        ax.set_title("사람인 의료 AI 채용 회사별 공고 수 Top 15",
                      fontsize=20, fontweight="bold", pad=15)
