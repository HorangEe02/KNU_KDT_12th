...
class DataCleaner:
    ...
    def __init__(self):
        ...
        self.domain_term_map = {
            "LiDAR": [r"라이다", r"LiDAR", r"lidar", r"LIDAR", r"라이더"],
            "RADAR": [r"레이더", r"RADAR", r"radar", r"레이다"],
            "ADAS": [r"에이다스", r"ADAS", r"adas", r"운전자보조시스템", r"첨단운전자보조"],
            "SLAM": [r"슬램", r"SLAM", r"slam", r"동시적위치추정"],
            "V2X": [r"브이투엑스", r"V2X", r"v2x", r"차량통신"],
            "AUTOSAR": [r"오토사", r"AUTOSAR", r"autosar"],
            "CAN": [r"캔통신", r"CAN버스"],
            "SDV": [r"소프트웨어정의차량", r"SDV", r"sdv"],
            "ROS": [r"로스", r"ROS", r"ros"],
        }
