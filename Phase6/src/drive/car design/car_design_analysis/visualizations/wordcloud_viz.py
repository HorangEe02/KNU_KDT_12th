...
워드클라우드 시각화 모듈
=============================================================
cross.png 마스크를 활용한 자동차 설계 특화 워드클라우드 6종 생성
=============================================================
"""
...
class WordCloudVisualizer:
    ...
    def generate_job_requirements_wordcloud(self, req_texts):
        ...
        self._create_wordcloud(
            req_texts,
            "모빌리티/제조 채용 자격요건·우대사항 워드클라우드",
            "wc_job_requirements.png",
            colormap="coolwarm",
        )

    def generate_domain_wordcloud(self, domain_texts):
        """자동차 설계 도메인 키워드 워드클라우드 (cross.png 마스크 적용)"""
        print("\n  [6/6] 자동차 설계 도메인 키워드 워드클라우드")
        self._create_wordcloud(
            domain_texts,
            "자동차 설계 도메인 키워드 워드클라우드",
            "wc_car_design_domain.png",
            colormap="YlGn",
        )
    ...
    def generate_all(self, data_dict: dict):
        ...
        Parameters:
            data_dict: {
                ...
                "car_design_domain": 자동차설계도메인 텍스트/딕셔너리,
            }
        """
        print("=" * 60)
        ...
        if data_dict.get("car_design_domain"):
            self.generate_domain_wordcloud(data_dict["car_design_domain"])
