...
class AnalysisDashboard:
    ...
    def _get_domain_freq(self):
        """자동차 설계 도메인 빈도"""
        return self._find_df("car_design_domain")
    ...
    def _draw_monthly_trend(self, ax):
        ...
        ax.set_title("월별 자동차설계 콘텐츠 동향 (최근 12개월)", fontsize=18, fontweight="bold")
    ...
    def _draw_domain(self, ax):
        ...
        ax.set_title("자동차 설계 도메인 분포", fontsize=18, fontweight="bold")
    ...
    def save_individual_charts(self):
        ...
        chart_specs = [
            ...
            (self._draw_domain,      "dashboard_07_domain.png",      (7, 7)),
    ...
    def create_summary_dashboard(self):
        ...
        fig.suptitle("자동차 설계 분야 취업 동향 종합 분석",
    ...
    def create_plotly_dashboard(self):
        ...
        fig = make_subplots(
            ...
            subplot_titles=[
                ...
                "자동차 설계 도메인 분포", "자격증/우대사항 빈도", "핵심 통계",
            ],
            specs=[
