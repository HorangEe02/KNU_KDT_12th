...
원티드 채용 포지션 시각화 모듈
=============================================================
원티드 모빌리티/제조 포지션 데이터를 활용한 시각화 7종 생성
- 자격요건/우대사항 워드클라우드
- 직무카테고리별 분포
- 업종별 분포
- 근무지(지역)별 분포
...
class WantedVisualizer:
    ...
    def plot_requirements_wordcloud(self):
        ...
        ax.set_title("원티드 모빌리티/제조 채용 자격요건 워드클라우드",
    ...
    def plot_industry_dist(self):
        ...
        ax.set_title("원티드 모빌리티/제조 업종별 포지션 분포",
    ...
    def plot_tech_stack_dist(self):
        ...
        ax.set_title("원티드 모빌리티/제조 기술스택 TOP 20",
                      fontsize=20, fontweight="bold", pad=15)
    ...
    def plot_career_range_dist(self):
        ...
        ax.set_title("원티드 모빌리티/제조 요구 경력 분포",
                      fontsize=20, fontweight="bold", pad=15)
    ...
    def plot_company_positions(self):
        ...
        ax.invert_yaxis()
        ax.set_xlabel("포지션 수", fontsize=16)
        ax.set_title("원티드 모빌리티/제조 회사별 채용 포지션 수 TOP 15",
                      fontsize=20, fontweight="bold", pad=15)
