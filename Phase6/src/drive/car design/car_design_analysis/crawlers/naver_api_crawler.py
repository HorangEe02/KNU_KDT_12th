"""
=============================================================
Naver OpenAPI 크롤러 - 자동차 설계 취업 동향 블로그/뉴스 수집
=============================================================
- 블로그, 뉴스 검색 API를 활용하여 자동차 설계 취준 동향 데이터 수집
...
class NaverAPICrawler:
    ...
    def _run_crawl(self, blog_keywords, news_keywords, file_suffix="자동차설계"):
        """블로그/뉴스 크롤링 내부 공통 로직
    ...
    def run_all(self, extra_blog_keywords=None, extra_news_keywords=None):
        ...
        return self._run_crawl(blog_kw, news_kw, file_suffix="자동차설계")

    def run_custom(self, blog_keywords=None, news_keywords=None, file_suffix="자동차설계_추가"):
        ...
        사용 예시:
            crawler.run_custom(
                blog_keywords=["삼성서울병원 AI 취업", "세브란스 자동차설계"],
                news_keywords=["삼성서울병원 AI 채용", "세브란스 인공지능"],
                file_suffix="자동차설계_대형기업",
            )
        """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="네이버 OpenAPI 자동차 설계 블로그/뉴스 크롤러")
    parser.add_argument(
