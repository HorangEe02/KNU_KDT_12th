...
class AnalysisDashboard:
    ...
    def _get_tech_stack(self):
        return self._find_df("tech_stack")
    ...
    def _get_domain_freq(self):
        return self._find_df("marketing_domain")
    ...
    def _draw_monthly_trend(self, ax):
        ...
        ax.set_title("월별 마케팅 콘텐츠 동향 (최근 12개월)", fontsize=14, fontweight="bold")
    ...
    def _draw_marketing_domain(self, ax):
        ...
        ax.set_title("마케팅 도메인 분포", fontsize=14, fontweight="bold")
    ...
    def save_individual_charts(self):
        ...
        chart_specs = [
            ...
            (self._draw_marketing_domain,    "dashboard_07_marketing_domain.png",    (7, 7)),
    ...
    def create_summary_dashboard(self):
        ...
        fig.suptitle("마케팅 분야 취업 동향 종합 분석",
