...
class ChartVisualizer:
    ...
    def plot_tech_stack_bar(self, tech_freq_df: pd.DataFrame):
        ...
        ax.set_title("마케팅 채용 기술스택 TOP 15", fontsize=16, fontweight="bold", pad=15)
    ...
    def plot_salary_boxplot(self, salary_data: pd.DataFrame):
        ...
        ax.set_title("마케팅 기업별 연봉 분포", fontsize=16, fontweight="bold", pad=15)
    ...
    def plot_company_ratings_grouped_bar(self, ratings_data: pd.DataFrame):
        ...
        ax.set_title("마케팅 기업 평점 항목별 비교", fontsize=16, fontweight="bold", pad=15)
    ...
    def plot_monthly_trend_line(self, monthly_data: pd.DataFrame):
        ...
        ax.set_title("월별 마케팅 채용공고 수 추이", fontsize=16, fontweight="bold", pad=15)
    ...
    def plot_location_bar(self, location_data: pd.DataFrame):
        ...
        ax.set_title("근무 지역별 마케팅 채용 분포", fontsize=16, fontweight="bold", pad=15)
    ...
    def plot_education_bar(self, education_data: pd.DataFrame):
        ...
        ax.set_ylabel("채용 공고 수", fontsize=12)
        ax.set_title("학력 조건 분포 (마케팅)", fontsize=16, fontweight="bold", pad=15)
        self._save(fig, "chart_education.png")

    def plot_marketing_domain_pie(self, domain_data: pd.DataFrame):
        """10. 마케팅 도메인별 채용 분포 파이차트"""
        if domain_data is None or domain_data.empty:
            print("  ⚠️ 마케팅 도메인 데이터 없음")
            return
        ...
        ax.set_title("마케팅 도메인별 채용 분포", fontsize=16, fontweight="bold", pad=15)
        self._save(fig, "chart_marketing_domain_pie.png")
    ...
    def generate_all(self, data_dict: dict):
        ...
        if data_dict.get("marketing_domain") is not None:
            self.plot_marketing_domain_pie(data_dict["marketing_domain"])
