...
class ContentTrendVisualizer:
    ...
    def plot_blog_vs_news_monthly(self):
        ...
        ax.set_xlabel("월")
        ax.set_ylabel("게시 건수")
        ax.set_title("블로그 vs 뉴스 월별 콘텐츠 추이 (최근 12개월)", fontsize=15, fontweight="bold")
    ...
    def plot_news_source_top15(self):
        ...
        ax.set_xlabel("기사 수")
        ax.set_title("뉴스 매체 분포 TOP 15", fontsize=15, fontweight="bold")
        fig.tight_layout()
    ...
    def plot_active_bloggers_top15(self):
        ...
        ax.set_xlabel("게시글 수")
        ax.set_title("활발 블로거 TOP 15", fontsize=15, fontweight="bold")
        fig.tight_layout()
    ...
    def plot_keyword_monthly_heatmap(self):
        ...
        ax.set_title("검색키워드별 월별 블로그 게시 현황", fontsize=15, fontweight="bold")
        ax.set_ylabel("")
        fig.tight_layout()
    ...
    def plot_weekday_pattern(self):
        ...
        ax.set_xticks(x)
        ax.set_xticklabels(weekday_kr, fontsize=11)
        ax.set_ylabel("게시 건수")
        ax.set_title("요일별 콘텐츠 게시 패턴", fontsize=15, fontweight="bold")
        ax.legend(fontsize=11)
        fig.tight_layout()
