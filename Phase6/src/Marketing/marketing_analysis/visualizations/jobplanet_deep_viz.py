...
class JobPlanetDeepVisualizer:
    ...
    def plot_job_type_distribution(self):
        ...
        ax.set_xlabel("리뷰 수")
        ax.set_title("직종별 리뷰 분포", fontsize=15, fontweight="bold")
        fig.tight_layout()
    ...
    def plot_location_distribution(self):
        ...
        for i, val in enumerate(counts.values[::-1]):
            ax.text(val + 0.3, i, str(val), va="center", fontsize=10, fontweight="bold")
        ax.set_xlabel("리뷰 수")
        ax.set_title("지역별 리뷰 분포", fontsize=15, fontweight="bold")
        fig.tight_layout()
    ...
    def plot_interview_route(self):
        ...
        ax.set_title("면접경로 분포", fontsize=15, fontweight="bold")
        fig.tight_layout()
    ...
    def plot_difficulty_heatmap(self):
        ...
        ax.set_title("기업별 면접난이도 분포", fontsize=15, fontweight="bold")
        ax.set_ylabel("")
        fig.tight_layout()
    ...
    def plot_company_job_type_stacked(self):
        ...
        ax.set_xlabel("리뷰 수")
        ax.set_title("기업별 직종 분포", fontsize=15, fontweight="bold")
        ax.legend(title="직종", bbox_to_anchor=(1.02, 1), loc="upper left", fontsize=9)
        fig.tight_layout()
    ...
    def plot_rating_vs_difficulty(self):
        ...
        ax.set_xlabel("평균 면접난이도 (1=매우 쉬움 ~ 5=매우 어려움)", fontsize=11)
        ax.set_ylabel("평균 별점 (5점 만점)", fontsize=11)
        ax.set_title("기업별 별점 vs 면접난이도", fontsize=15, fontweight="bold")
        ax.set_xlim(0.5, 5.5)
        ax.set_ylim(0.5, 5.5)
