...
class TextAnalyzer:
    ...
    def __init__(self):
        ...
        # 의료 도메인 사용자 사전
        self.medical_terms = [
            "의료영상", "디지털헬스", "인허가", "임상시험", "바이오마커",
            "의료기기", "디지털치료제", "원격의료", "전자의무기록",
            "의료정보", "헬스케어", "바이오인포매틱스",
        ]
    ...
    def get_medical_domain_frequency(self, job_data: pd.DataFrame) -> pd.DataFrame:
        ...
        for category, keywords in MEDICAL_DOMAIN_KEYWORDS.items():
...
if __name__ == "__main__":
    ...
    # 테스트
    test_text = "Python, PyTorch, TensorFlow 활용한 의료영상 CT/MRI AI 분석 경력 3~5년"
